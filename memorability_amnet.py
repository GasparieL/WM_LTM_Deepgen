...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/lana/Desktop/psychoPyExperiments/wm_deepgen/WM_Deepgen_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    image_input = visual.ImageStim(
        ...
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=0.0)
    image_recall_response = keyboard.Keyboard()
    ...
    thanks = visual.TextStim(win=win, name='thanks',
        text='Thank you for your participation!\n\nThis page will redirect back to Qualtrics.',
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    thisExp.addData('setup_js.started', globalClock.getTime())
    ...
    thisExp.addData('setup_js.stopped', globalClock.getTime())
    ...
    for thisTrial in trials:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('Instructions5.started', globalClock.getTime())
        key_resp_10.keys = []
        key_resp_10.rt = []
        ...
        for thisComponent in Instructions5Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('Instructions5.stopped', globalClock.getTime())
        # check responses
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('Instructions6b.started', globalClock.getTime())
        key_resp_16.keys = []
        key_resp_16.rt = []
        ...
        for thisComponent in Instructions6bComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('Instructions6b.stopped', globalClock.getTime())
        # check responses
        ...
        for thisRepeat_prac in repeat_prac:
            ...
            continueRoutine = True
            # update component parameters for each repeat
            thisExp.addData('Instructions6.started', globalClock.getTime())
            key_resp_13.keys = []
            key_resp_13.rt = []
            ...
            for thisComponent in Instructions6Components:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            thisExp.addData('Instructions6.stopped', globalClock.getTime())
            # check responses
            ...
            for thisPrac_trial in prac_trials:
                ...
                continueRoutine = True
                # update component parameters for each repeat
                thisExp.addData('memoranda.started', globalClock.getTime())
                ...
                for thisComponent in memorandaComponents:
                    if hasattr(thisComponent, "setAutoDraw"):
                        thisComponent.setAutoDraw(False)
                thisExp.addData('memoranda.stopped', globalClock.getTime())
                ...
                continueRoutine = True
                # update component parameters for each repeat
                thisExp.addData('isi1.started', globalClock.getTime())
                # keep track of which components have finished
                ...
                for thisComponent in isi1Components:
                    if hasattr(thisComponent, "setAutoDraw"):
                        thisComponent.setAutoDraw(False)
                thisExp.addData('isi1.stopped', globalClock.getTime())
                ...
                continueRoutine = True
                # update component parameters for each repeat
                thisExp.addData('correct_ans.started', globalClock.getTime())
                ...
                for thisComponent in correct_ansComponents:
                    if hasattr(thisComponent, "setAutoDraw"):
                        thisComponent.setAutoDraw(False)
                thisExp.addData('correct_ans.stopped', globalClock.getTime())
            ...
            continueRoutine = True
            # update component parameters for each repeat
            thisExp.addData('repeat_code.started', globalClock.getTime())
            key_resp_14.keys = []
            key_resp_14.rt = []
            ...
            for thisComponent in repeat_codeComponents:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            thisExp.addData('repeat_code.stopped', globalClock.getTime())
            # check responses
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('Instructions7.started', globalClock.getTime())
        key_resp_15.keys = []
        key_resp_15.rt = []
        ...
        for thisComponent in Instructions7Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('Instructions7.stopped', globalClock.getTime())
        # check responses
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('Instructions8.started', globalClock.getTime())
        key_resp_6.keys = []
        key_resp_6.rt = []
        _key_resp_6_allKeys = []
        ...
        for thisComponent in Instructions8Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('Instructions8.stopped', globalClock.getTime())
        # check responses
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('Instructions9.started', globalClock.getTime())
        ...
        for thisComponent in Instructions9Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('Instructions9.stopped', globalClock.getTime())
        # check responses
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('Instructions10.started', globalClock.getTime())
        ...
        for thisComponent in Instructions10Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('Instructions10.stopped', globalClock.getTime())
        # check responses
        ...
        demo_prac_task = data.TrialHandler(nReps=1.0, method='sequential', 
            extraInfo=expInfo, originPath=-1,
            trialList=data.importConditions('taskPhases.csv'),
        ...
        for thisDemo_prac_task in demo_prac_task:
            ...
            for thisRepeat_practice in repeat_practice:
                ...
                continueRoutine = True
                # update component parameters for each repeat
                thisExp.addData('intro_txt.started', globalClock.getTime())
                ...
                for thisComponent in intro_txtComponents:
                    if hasattr(thisComponent, "setAutoDraw"):
                        thisComponent.setAutoDraw(False)
                thisExp.addData('intro_txt.stopped', globalClock.getTime())
                # check responses
                ...
                continueRoutine = True
                # update component parameters for each repeat
                thisExp.addData('initial_wait.started', globalClock.getTime())
                # keep track of which components have finished
                ...
                for thisComponent in initial_waitComponents:
                    if hasattr(thisComponent, "setAutoDraw"):
                        thisComponent.setAutoDraw(False)
                thisExp.addData('initial_wait.stopped', globalClock.getTime())
                # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
                if routineForceEnded:
                    routineTimer.reset()
                else:
                ...
                for thisLoop_trial in loop_trials:
                    ...
                    continueRoutine = True
                    # update component parameters for each repeat
                    thisExp.addData('reliability_cue.started', globalClock.getTime())
                    ...
                    for thisComponent in reliability_cueComponents:
                        if hasattr(thisComponent, "setAutoDraw"):
                            thisComponent.setAutoDraw(False)
                    thisExp.addData('reliability_cue.stopped', globalClock.getTime())
                    ...
                    continueRoutine = True
                    # update component parameters for each repeat
                    thisExp.addData('isi2.started', globalClock.getTime())
                    # keep track of which components have finished
                    ...
                    for thisComponent in isi2Components:
                        if hasattr(thisComponent, "setAutoDraw"):
                            thisComponent.setAutoDraw(False)
                    thisExp.addData('isi2.stopped', globalClock.getTime())
                    ...
                    continueRoutine = True
                    # update component parameters for each repeat
                    thisExp.addData('ping.started', globalClock.getTime())
                    ...
                    for thisComponent in pingComponents:
                        if hasattr(thisComponent, "setAutoDraw"):
                            thisComponent.setAutoDraw(False)
                    thisExp.addData('ping.stopped', globalClock.getTime())
                    ...
                    continueRoutine = True
                    # update component parameters for each repeat
                    thisExp.addData('noise_mask.started', globalClock.getTime())
                    # keep track of which components have finished
                    ...
                    for thisComponent in noise_maskComponents:
                        if hasattr(thisComponent, "setAutoDraw"):
                            thisComponent.setAutoDraw(False)
                    thisExp.addData('noise_mask.stopped', globalClock.getTime())
                    ...
                    continueRoutine = True
                    # update component parameters for each repeat
                    thisExp.addData('isi3.started', globalClock.getTime())
                    # keep track of which components have finished
                    ...
                    for thisComponent in isi3Components:
                        if hasattr(thisComponent, "setAutoDraw"):
                            thisComponent.setAutoDraw(False)
                    thisExp.addData('isi3.stopped', globalClock.getTime())
                ...
                continueRoutine = True
                # update component parameters for each repeat
                thisExp.addData('repeat_practice_code.started', globalClock.getTime())
                key_resp_12.keys = []
                key_resp_12.rt = []
                ...
                for thisComponent in repeat_practice_codeComponents:
                    if hasattr(thisComponent, "setAutoDraw"):
                        thisComponent.setAutoDraw(False)
                thisExp.addData('repeat_practice_code.stopped', globalClock.getTime())
                # check responses
    ...
    # set up handler to look after randomisation of conditions etc
    trials_2 = data.TrialHandler(nReps=0.0, method='random', 
        extraInfo=expInfo, originPath=-1,
    ...
    for thisTrial_2 in trials_2:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('image_recall_task.started', globalClock.getTime())
        ...
        for thisComponent in image_recall_taskComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('image_recall_task.stopped', globalClock.getTime())
        # check responses
        ...
        if thisSession is not None:
            # if running in a Session with a Liaison client, send data up to now
            thisSession.sendExperimentData()
    # completed 0.0 repeats of 'trials_2'
    
    
    # --- Prepare to start Routine "questionaire" ---
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('questionaire.started', globalClock.getTime())
    # keep track of which components have finished
    ...
    for thisComponent in questionaireComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('questionaire.stopped', globalClock.getTime())
